    ...
    if (pros.username === "Авторизация") {
        ...
        <Dropdown>
            ...
            <Dropdown.Menu>
                ...
                <Dropdown.Item href="https://github.com/login/oauth/authorize?client_id=Iv23liDMCg3eeIfAIYy1&redirect_uri=http://localhost:5173/&scope=read:user">Войти через Github</Dropdown.Item>
